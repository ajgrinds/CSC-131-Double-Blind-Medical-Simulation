...
var _chunkO4DTJHFRjs = require('./chunk-O4DTJHFR.js');
...
var require_consola = _chunkQ2NKY6R2js.__commonJS.call(void 0, {
  "node_modules/.pnpm/consola@2.15.3/node_modules/consola/dist/consola.js"(exports, module) {
    ...
    var t = _chunkQ2NKY6R2js.__require.call(void 0, "fs");
...
async function runEsbuild(options, {
  ...
  const pkg = await _chunkO4DTJHFRjs.loadPkg.call(void 0, process.cwd());
  const deps = await _chunkO4DTJHFRjs.getDeps.call(void 0, process.cwd());
  const external = [
  ...
  try {
    result = await _esbuild.build.call(void 0, {
      ...
      define: _chunkQ2NKY6R2js.__spreadValues.call(void 0, _chunkQ2NKY6R2js.__spreadValues.call(void 0, _chunkQ2NKY6R2js.__spreadValues.call(void 0, {
...
var sizeReporter = () => {
  return {
    ...
    buildEnd({ writtenFiles }) {
      _chunkO4DTJHFRjs.reportSize.call(void 0, this.logger, this.format, writtenFiles.reduce((res, file) => {
        return _chunkQ2NKY6R2js.__spreadProps.call(void 0, _chunkQ2NKY6R2js.__spreadValues.call(void 0, {}, res), {
          [file.name]: file.size
        });
      }, {}));
...
var normalizeOptions = async (logger, optionsFromConfigFile, optionsOverride) => {
  ...
  _chunkO4DTJHFRjs.setSilent.call(void 0, options.silent);
...
async function build(_options) {
  const config = _options.config === false ? {} : await _chunkO4DTJHFRjs.loadTsupConfig.call(void 0, process.cwd());
  ...
  await Promise.all([...Array.isArray(configData) ? configData : [configData]].map(async (item) => {
    const logger = _chunkO4DTJHFRjs.createLogger.call(void 0, item == null ? void 0 : item.name);
