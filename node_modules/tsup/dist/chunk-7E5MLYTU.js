...
var require_flat = _chunkQ2NKY6R2js.__commonJS.call(void 0, {
...
// src/cli-main.ts
_chunkQ2NKY6R2js.init_cjs_shims.call(void 0, );
var import_flat = _chunkQ2NKY6R2js.__toESM.call(void 0, require_flat());
var _fs = require('fs');
...
async function main(options = {}) {
  ...
  cli.command("[...files]", "Bundle files", {
    ...
    default: "node"
  }).option("--loader <ext=loader>", "Specify the loader for a file extension").option("--no-config", "Disable config file").option("--no-shims", "Disable cjs and esm shims").option("--inject-style", "Inject style tag to document head").action(async (files, flags) => {
    const { build } = await Promise.resolve().then(() => require("./index.js"));
    Object.assign(options, _chunkQ2NKY6R2js.__spreadValues.call(void 0, {}, flags));
    if (files.length > 0) {
      options.entry = files.map(_chunkQ2NKY6R2js.slash);
    }
    if (flags.format) {
    ...
    if (flags.loader) {
      ...
      options.loader = loader.reduce((result, item) => {
        ...
        return _chunkQ2NKY6R2js.__spreadProps.call(void 0, _chunkQ2NKY6R2js.__spreadValues.call(void 0, {}, result), {
          [parts[0]]: parts[1]
        });
      }, {});
    }
